<template>
  ...
  <div class="mt-6 text-center" style="border: 1cm; border-radius: 2px">
...
// Clipboard functionality for copying the Peer ID
...
// Clipboard functionality for pasting the Peer ID
// const pastePeerId = async () => {
//   try {
//     const text = await navigator.clipboard.readText();
//     if (text) {
//       remotePeerId.value = text; // Set the pasted text to the remotePeerId input field
//       alert("Peer ID pasted from clipboard!");
//     } else {
