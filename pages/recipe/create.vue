...
const {data:categResp,loading:loadingCategResponse,refresh:refetch} =useFetch<PaginatedApiResponse>(endpoints.recipe.category.index,{
  method:"post",
  body:{
    status:"active"
  },
